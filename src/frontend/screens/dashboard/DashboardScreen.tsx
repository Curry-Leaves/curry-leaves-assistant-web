...
/** Tile-based agent dashboard: switch between named boards, add agents as tiles,
 *  drag/resize freely, configure each tile's brief + output shape + refresh, and
 *  watch tiles repopulate live as their agents run. */
export function DashboardScreen({ agents }: { agents: Agent[] }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      <div className="flex items-center px-3 h-12 flex-none border-b border-border">
        ...
        <h1 className="font-serif italic text-[20px] text-ink flex-none px-3">{board?.name ?? 'Dashboard'}</h1>
        <div className="flex-1 flex justify-end"><AddTileMenu agents={tileableAgents} onPick={addTile} /></div>
      </div>
